...
void displayWelcome() {
    ...
    M5.Display.drawString("M5GFX Text", M5.Display.width()/2, 40);
    
    M5.Display.setTextSize(2);
    M5.Display.setTextColor(TFT_CYAN);
    M5.Display.drawString("Rendering", M5.Display.width()/2, 90);
    M5.Display.drawString("System", M5.Display.width()/2, 120);
    
    M5.Display.setTextSize(1);
    M5.Display.setTextColor(TFT_YELLOW);
    M5.Display.drawString("Master fonts, alignment, and text effects", M5.Display.width()/2, 160);
    
    M5.Display.setTextColor(TFT_WHITE);
    M5.Display.drawString("• Built-in and Custom Fonts", M5.Display.width()/2, 180);
    M5.Display.drawString("• Alignment and Positioning", M5.Display.width()/2, 195);
    M5.Display.drawString("• Colors and Effects", M5.Display.width()/2, 210);
}
...
void displayCurrentDemo() {
    ...
    M5.Display.setTextSize(2);
    M5.Display.setTextDatum(TC_DATUM);
    M5.Display.drawString("M5GFX Text", M5.Display.width()/2, 10);
    
    // Current demo name
    M5.Display.setTextColor(TFT_YELLOW);
    M5.Display.setTextSize(1);
    M5.Display.drawString(textDemoNames[currentDemo], M5.Display.width()/2, 35);
    
    // Demo counter
    M5.Display.setTextColor(TFT_WHITE);
    M5.Display.drawString("Demo " + String(currentDemo + 1) + " of " + String(TEXT_DEMO_COUNT), M5.Display.width()/2, 50);
    
    // Navigation hint
    M5.Display.setTextColor(TFT_GREEN);
    M5.Display.setTextDatum(BC_DATUM);
    M5.Display.drawString("[A] Prev  [B] Animate  [C] Next", M5.Display.width()/2, M5.Display.height() - 10);
